...
description: Genera una landing page cinematográfica de "1:1 Píxel Perfecto" para cualquier tipo de negocio usando React 19, Tailwind CSS y GSAP. Antes de construir, el agente hace 8 preguntas para personalizar completamente todas las variables del diseño (marca, paleta, hero, dashboard, manifiesto, colección, planes y footer). Úsala cuando el usuario quiera crear una web premium, cinematográfica o de alto impacto visual para cualquier sector.
version: 1.0.0
---
...
>
> **7. 🗂️ Colección de servicios o productos**
